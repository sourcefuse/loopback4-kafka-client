...
If you've noticed a bug or have a question, [search the issue tracker](https://github.com/sourcefuse/loopback4-kafka-client/issues) to see if
someone else in the community has already created a ticket. If not, go ahead and
[make one](https://github.com/sourcefuse/loopback4-kafka-client/issues/new/choose)!
...
up to date with loopback4-kafka-client's master branch:

```sh
git remote add upstream git@github.com:sourcefuse/loopback4-kafka-client.git
git checkout master
